    ...
    if (simpan($_POST)) {
        echo "<script>
                ...
                window.onload = function(){
                    let win = window.open('../struk.php?nota=$nota', 'Struk Belanja',
            ...
            <div class="content-wrapper">
                <main>
                        ...
                        <div class="container-fluid">
                            <form action="" method="post">
                                ...
                                <div class="card pt-1 pb-2 px-3">
                                    <div class="row">
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="<?= @$_GET['barcode'] ? $selectbrg['kode_barang'] : '' ?>" name="kode_barang">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary btn-block" name="addbrg" onclick="addbrg"><i class="fas fa-cart-plus fa-sm"></i> Tambah Barang</button>
                                </div><br>
                                <div class="card card-outline card-success table-responsive px-2">
                                    <table class="table table-sm table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $brgDetail = mysqli_query($conn, "SELECT * FROM penjualan_detail WHERE no_jual = '$maxno'");
                                            foreach ($brgDetail as $detail) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $detail['qty'] ?></td>
                                                    <td><?= $detail['jml_hrg'] ?></td>
                                                    <td class="text-center">
                                                        <a href="?barcode=<?= $detail['barcode'] ?> &idjual=<?= $detail['no_jual'] ?>
                                                            &qty=<?= $detail['qty'] ?>&tgl=<?= $detail['tgl_jual'] ?>&msg=deleted" class="btn btn-sm btn-danger" title="hapus barang" onclick="return confirm('Anda yakin ajan menghapus barang ini?')"><i class="fas fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            };
                    ...
                    <script>
                        ...
                        let jml_hrg = document.getElementById('jml_hrg');
