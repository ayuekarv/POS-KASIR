...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <a href="export-stok01.php" class="btn btn-info text-white mb-4">Export Data</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>Rp <?= $hargaawal; ?></td>
                                                <td>Rp <?= $hargajual; ?></td>
                                                <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $kode_barang; ?>">
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $kode_barang; ?>">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
    ...
    <script src="{{ '/assets/jquery.min.js' | prepend: site.baseurl }}"></script>
    <script src="{{ '/assets/bootstrap.bundle.min.js' | prepend: site.baseurl }}"></script>
    <script src="{{ '/assets/jquery.overlayScrollbars.min.js' | prepend: site.baseurl }}"></script>
    <script src="{{ '/assets/adminlte.min.js' | prepend: site.baseurl }}"></script>
</body>
